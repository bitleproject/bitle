...
sub256_modm_batch(bignum256modm out, const bignum256modm a, const bignum256modm b, size_t limbsize) {
	...
	switch (limbsize) {
		case 8: out[i] = (a[i] - b[i]) - carry; carry = (out[i] >> 31); out[i] &= 0x3fffffff; i++; __attribute__((fallthrough));
		case 7: out[i] = (a[i] - b[i]) - carry; carry = (out[i] >> 31); out[i] &= 0x3fffffff; i++; __attribute__((fallthrough));
		case 6: out[i] = (a[i] - b[i]) - carry; carry = (out[i] >> 31); out[i] &= 0x3fffffff; i++; __attribute__((fallthrough));
		case 5: out[i] = (a[i] - b[i]) - carry; carry = (out[i] >> 31); out[i] &= 0x3fffffff; i++; __attribute__((fallthrough));
		case 4: out[i] = (a[i] - b[i]) - carry; carry = (out[i] >> 31); out[i] &= 0x3fffffff; i++; __attribute__((fallthrough));
		case 3: out[i] = (a[i] - b[i]) - carry; carry = (out[i] >> 31); out[i] &= 0x3fffffff; i++; __attribute__((fallthrough));
		case 2: out[i] = (a[i] - b[i]) - carry; carry = (out[i] >> 31); out[i] &= 0x3fffffff; i++; __attribute__((fallthrough));
		case 1: out[i] = (a[i] - b[i]) - carry; carry = (out[i] >> 31); out[i] &= 0x3fffffff; i++; __attribute__((fallthrough));
		case 0: 
...
lt256_modm_batch(const bignum256modm a, const bignum256modm b, size_t limbsize) {
	switch (limbsize) {
		case 8: if (a[8] > b[8]) return 0; if (a[8] < b[8]) return 1; __attribute__((fallthrough));
		case 7: if (a[7] > b[7]) return 0; if (a[7] < b[7]) return 1; __attribute__((fallthrough));
		case 6: if (a[6] > b[6]) return 0; if (a[6] < b[6]) return 1; __attribute__((fallthrough));
		case 5: if (a[5] > b[5]) return 0; if (a[5] < b[5]) return 1; __attribute__((fallthrough));
		case 4: if (a[4] > b[4]) return 0; if (a[4] < b[4]) return 1; __attribute__((fallthrough));
		case 3: if (a[3] > b[3]) return 0; if (a[3] < b[3]) return 1; __attribute__((fallthrough));
		case 2: if (a[2] > b[2]) return 0; if (a[2] < b[2]) return 1; __attribute__((fallthrough));
		case 1: if (a[1] > b[1]) return 0; if (a[1] < b[1]) return 1; __attribute__((fallthrough));

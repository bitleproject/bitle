...
#if (defined(__SIZEOF_INT128__) && defined(__LP64__)) || (defined(_MSC_VER) && defined(_M_X64)) || (defined(__GNUC__) && defined(__LP64__) && ((__GNUC__ > 4) || ((__GNUC__ == 4) && (__GNUC_MINOR__ >= 4))))
#include "poly1305-donna-64.h"
#else
#include "poly1305-donna-32.h"
#endif
